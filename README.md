...
Useful Links:
	...
	1. Setting up an AWS Instance with LAMP and Git
  
		a. Good (though a bit old) tutorial: http://devoncmather.com/setting-aws-ec2-instance-lamp-git/
    
		Install the latest Ubuntu.
	
		a. Youtube Explanation: https://www.youtube.com/watch?v=wNr7YqjjzOY
    
		b. http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/get-set-up-for-amazon-ec2.html 
		
		c. https://help.ubuntu.com/community/ApacheMySQLPHP
 ...
    The instructions below are intended for Apache. NGINX and Node are slightly different.
    ...
    Run SSL Labs on your config and report your observations to class.
